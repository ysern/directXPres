...
bool SetupScene() { //Set up our Scene
	...
	const char* pathToVertexShader = "..\\Example7_Texture\\VertexShader.h";
	ID3DXBuffer* pCode;
	...
	const char* pathToPixelShader = "..\\Example7_Texture\\PixelShader.h";
	...
	// Load texture
	D3DXCreateTextureFromFile(d3dDevice, "..\\Example7_Texture\\bv_logo.png", &g_pTexture);
	//D3DXCreateTextureFromFile(d3dDevice, "..\\Example7_Texture\\bv_logo_small.png", &g_pTexture);
