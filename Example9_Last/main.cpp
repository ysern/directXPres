...
bool SetupScene() { //Set up our Scene
	...
	const char* pathToVertexShader = "..\\Example9_Last\\VertexShader.h";
	ID3DXBuffer* pCode;
	...
	const char* pathToPixelShader = "..\\Example9_Last\\PixelShader.h";
	...
	// Load texture
	D3DXCreateTextureFromFile(d3dDevice, "..\\Example9_Last\\thats-all-folks.jpg", &g_pTexture);
...
int messageloop(bool(*display)(float timeDelta)) {    //The message loop
	...
	while (TRUE)    //While there is a message
	{
		...
		if (PeekMessage(&msg, NULL, 0, 0, PM_REMOVE))
		{
			...
			timeDelta += (currTime - lastTime)*0.0001f;
